...
![./img/8-1.png](/Users/zhangyue/MyDoc/博客文章/dev-blog/xunsearch/img/8-1.png)

这就是我之前测试过的内容，demo 大家一定不陌生了。而 zyarticle 则是在讲索引配置时我们建立的新的索引项目。每个项目文件夹内又包含两个主要索引数据库。

![./img/8-2.png](/Users/zhangyue/MyDoc/博客文章/dev-blog/xunsearch/img/8-2.png)
...
![./img/8-3.png](/Users/zhangyue/MyDoc/博客文章/dev-blog/xunsearch/img/8-3.png)
...
添加完全附加文本和阶段词法索引之后，我们还可以通过 getAddIndex() 和 getAddTerms() 查看它们。
...
> php vendor/hightman/xunsearch/util/Quest.php --show-query ./config/zyarticle.ini "印度喜欢吃咖喱" 
```
...
print_r($xs->search->addQueryTerm('title', '印度喜欢吃咖喱')->search('')); // 能查到
```
